...
f = h5py.File("nf_ana.h5", "r+") # use the file after the field off simulation is run
...
images[0].save('densityoff.gif', save_all=True, append_images=images[1:], duration=10)
